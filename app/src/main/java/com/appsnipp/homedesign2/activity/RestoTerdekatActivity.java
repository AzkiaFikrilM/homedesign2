...
public class RestoTerdekatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resto_terdekat);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Restoran Terdekat");

        storage = FirebaseStorage.getInstance();
        storageReference = storage.getReference("restoTerdekat");
        databaseReference = FirebaseDatabase.getInstance().getReference("restoTerdekat");

        recyclerView = findViewById(R.id.recycler_view);
        progressBar = findViewById(R.id.progress_bar);
        tv_kosong = findViewById(R.id.tv_kosong_terdekat);
        progressDialog = new ProgressDialog(this);

        swipeRefreshLayout = findViewById(R.id.swipe_terdekat);
