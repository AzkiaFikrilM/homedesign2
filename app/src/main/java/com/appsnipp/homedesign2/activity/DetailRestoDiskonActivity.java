...
public class DetailRestoDiskonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_resto_diskon);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        ImageView img_foto = findViewById(R.id.img_resto_diskon);
        TextView tv_name = findViewById(R.id.tv_name_diskon);
        TextView tv_desc = findViewById(R.id.tv_deskripsi_diskon);
        TextView tv_kategori = findViewById(R.id.tv_kategori_diskon);
        ...
        if (bundle != null) {
            ...
            tv_kategori.setText("Diskon: "+kategori);
